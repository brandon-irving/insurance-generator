...
import geicoImage from '../static/geicoBackground.jpg';
    ...
    return (
        <div id="geicoInsurance">
            ...
            <div style={{ position: 'absolute', left: '50%', marginLeft: '-306px', top: '75px', width: '612px', height: '792px', overflow: 'hidden' }}>
                ...
                <div style={{ position: 'absolute', left: '371.52px', top: '4.12px' }} className="cls_002"><span className="cls_002">Important Information</span></div>
                <div style={{ position: 'absolute', left: '74.88px', top: '17.20px' }} className="cls_004"><span className="cls_004">IDENTIFICATION CARD</span></div>
                <div style={{ position: 'absolute', left: '281.52px', top: '20.48px' }} className="cls_005"><span className="cls_005">Here are your Policy Identification Cards.  Two cards have been</span></div>
                <div style={{ position: 'absolute', left: '7.20px', top: '28.32px' }} className="cls_006"><span className="cls_006">GEICO GENERAL INSURANCE COMPANY</span></div>
                ...
                <div style={{ position: 'absolute', left: '281.52px', top: '71.12px' }} className="cls_005"><span className="cls_005">and the Co-insured are listed. For a full list of drivers covered</span></div>
                <div style={{ position: 'absolute', left: '7.20px', top: '81.28px' }} className="cls_004"><span className="cls_004">Named Insured:</span><span className="cls_007"> {name}</span></div>
                <div style={{ position: 'absolute', left: '281.52px', top: '82.64px' }} className="cls_005"><span className="cls_005">under this policy, please log onto geico.com or reference the</span></div>
                <div style={{ position: 'absolute', left: '281.52px', top: '94.16px' }} className="cls_005"><span className="cls_005">Drivers section of your Declarations Page, which is included with</span></div>
                <div style={{ position: 'absolute', left: '7.20px', top: '100.00px' }} className="cls_004"><span className="cls_004">Year</span></div>
                <div style={{ position: 'absolute', left: '45.12px', top: '100.00px' }} className="cls_004"><span className="cls_004">Make</span></div>
                <div style={{ position: 'absolute', left: '104.40px', top: '100.00px' }} className="cls_004"><span className="cls_004">Model</span></div>
                <div style={{ position: 'absolute', left: '170.40px', top: '100.00px' }} className="cls_004"><span className="cls_004">Vehicle ID No.</span></div>
                <div style={{ position: 'absolute', left: '7.20px', top: '108.88px' }} className="cls_007"><span className="cls_007">{year}</span></div>
                <div style={{ position: 'absolute', left: '44.40px', top: '108.88px' }} className="cls_007"><span className="cls_007">{make.toUpperCase()}</span></div>
                <div style={{ position: 'absolute', left: '95.76px', top: '108.88px' }} className="cls_007"><span className="cls_007">{model.toUpperCase()}</span></div>
                <div style={{ position: 'absolute', left: '159.36px', top: '108.88px' }} className="cls_007"><span className="cls_007">{vin.toUpperCase()}</span></div>
                ...
                <div style={{ position: 'absolute', left: '281.52px', top: '133.28px' }} className="cls_005"><span className="cls_005">sure you receive all important policy documents.  Prompt</span></div>
                <div style={{ position: 'absolute', left: '39.12px', top: '147.52px' }} className="cls_007"><span className="cls_007">Not valid more than one year from effective date.</span></div>
                <div style={{ position: 'absolute', left: '281.52px', top: '144.80px' }} className="cls_005"><span className="cls_005">notification will enable us to service you better.</span></div>
                <div style={{ position: 'absolute', left: '281.52px', top: '160.88px' }} className="cls_005"><span className="cls_005">Your policy is recorded under the name and policy number shown</span></div>
                <div style={{ position: 'absolute', left: '77.04px', top: '170.08px' }} className="cls_004"><span className="cls_004">FLORIDA AUTOMOBILE  INSURANCE</span></div>
                <div style={{ position: 'absolute', left: '281.52px', top: '172.40px' }} className="cls_005"><span className="cls_005">on the card.</span></div>
                <div style={{ position: 'absolute', left: '77.04px', top: '179.44px' }} className="cls_004"><span className="cls_004">IDENTIFICATION CARD</span></div>
                ...
                <div style={{ position: 'absolute', left: '7.20px', top: '240.40px' }} className="cls_004"><span className="cls_004">Named Insured:</span><span className="cls_007"> {name}</span></div>
                <div style={{ position: 'absolute', left: '7.20px', top: '260.56px' }} className="cls_004"><span className="cls_004">Year</span></div>
                <div style={{ position: 'absolute', left: '45.36px', top: '260.56px' }} className="cls_004"><span className="cls_004">Make</span></div>
                <div style={{ position: 'absolute', left: '102.96px', top: '260.56px' }} className="cls_004"><span className="cls_004">Model</span></div>
                <div style={{ position: 'absolute', left: '170.16px', top: '260.56px' }} className="cls_004"><span className="cls_004">Vehicle ID No.</span></div>
                <div style={{ position: 'absolute', left: '7.20px', top: '268.48px' }} className="cls_007"><span className="cls_007">{year}</span></div>
                <div style={{ position: 'absolute', left: '43.92px', top: '268.48px' }} className="cls_007"><span className="cls_007">{make.toUpperCase()}</span></div>
                <div style={{ position: 'absolute', left: '95.52px', top: '268.48px' }} className="cls_007"><span className="cls_007">{model.toUpperCase()}</span></div>
                <div style={{ position: 'absolute', left: '158.88px', top: '268.48px' }} className="cls_007"><span className="cls_007">{vin.toUpperCase()}</span></div>
                ...
                <div style={{ position: 'absolute', left: '330.24px', top: '286.40px' }} className="cls_005"><span className="cls_005">{addressLine1.toUpperCase()}</span></div>
                <div style={{ position: 'absolute', left: '330.24px', top: '297.92px' }} className="cls_005"><span className="cls_005">{addressLine2.toUpperCase()}</span></div>
                <div style={{ position: 'absolute', left: '39.12px', top: '306.88px' }} className="cls_007"><span className="cls_007">Not valid more than one year from effective date.</span></div>
                <div style={{ position: 'absolute', left: '156.00px', top: '514.56px' }} className="cls_010"><span className="cls_010">VOID</span></div>
                <div style={{ position: 'absolute', left: '411.60px', top: '514.56px' }} className="cls_010"><span className="cls_010">VOID</span></div>
                <div style={{ position: 'absolute', left: '156.00px', top: '667.44px' }} className="cls_010"><span className="cls_010">VOID</span></div>
                <div style={{ position: 'absolute', left: '411.60px', top: '667.44px' }} className="cls_010"><span className="cls_010">VOID</span></div>
            </div>
        </div>
    );
